...
exports.updateEventsConfig = void 0;
const fs = require("fs-extra");
const path = require("path");
async function updateEventsConfig(eventKey) {
...
exports.updateEventsConfig = updateEventsConfig;
function addEventToConfig(content, domain, event) {
