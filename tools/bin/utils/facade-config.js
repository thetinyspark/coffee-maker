...
exports.updateFacadeConfig = void 0;
const fs = require("fs-extra");
const path = require("path");
async function updateFacadeConfig(componentName, eventKey, type = 'command') {
...
exports.updateFacadeConfig = updateFacadeConfig;
function addComponentRegistration(content, componentName, eventKey, type) {
